...
def main():
    ...
    while run:
        ...
        if key[pygame.K_d] and player.x + player_vel + player.get_width() < WIDTH:  # right
            player.x += player_vel
        if key[pygame.K_s] and player.y + player_vel + player.get_height() + 20 < HEIGHT:  # down
            player.y += player_vel
...
def main_menu():
    ...
    while run:
        ...
        title_comment = title_font.render("Or press q to quit", 0.5, (255, 255, 255))
        WIN.blit(title_label, (WIDTH/2 - title_label.get_width()/2, 350))
        WIN.blit(title_comment, (WIDTH/2 - title_comment.get_width()/2, 420))
